!(function (t, e) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = e() : typeof define === 'function' && define.amd ? define(e) : (t = typeof globalThis !== 'undefined' ? globalThis : t || self).jsVectorMap = e()
}(this, function () {
  'use strict'
  Element.prototype.matches || (Element.prototype.matches = Element.prototype.matchesSelector || Element.prototype.mozMatchesSelector || Element.prototype.msMatchesSelector || Element.prototype.oMatchesSelector || Element.prototype.webkitMatchesSelector || function (t) {
    ...
    value: function (t) {
      ...
      for (var e = Object(t), i = 1; i < arguments.length; i++) {
        ...
        if (s != null) {
          s = Object(s)
          for (let a = Object.keys(Object(s)), r = 0, n = a.length; r < n; r++) {
            const o = a[r]
            const h = Object.getOwnPropertyDescriptor(s, o)
  ...
  const t = {}
  let e = 1
  const i = function (i, s, a, r) {
    void 0 === r && (r = {}), t['jvm:' + s + '::' + e++] = {
      selector: i,
      handler: a
    }, i.addEventListener(s, a, r)
  }
  const s = function (e, i, s) {
    const a = i.split(':')[1]
  ...
  const r = (function () {
    ...
    return e.on = function (t, e, s) {
      ...
      for (const e in t) this.selector.style[e] = t[e]
      return this
    }, e.text = function (t) {
      ...
      return this.selector.classList ? (this.selector.classList.add(t), this) : (this.selector.className.split(' ').indexOf(t) == -1 && (this.selector.className += ' ' + t), this)
    }, e.append = function (t) {
  ...
  function p (t, e, i) {
    ...
    return i.isMergeableObject(t) && c(t).forEach(function (e) {
      ...
      })(t, a) || (u(t, a) && i.isMergeableObject(e[a])
        ? s[a] = (function (t, e) {
          if (!e.customMerge) return d
          const i = e.customMerge(t)
          return typeof i === 'function' ? i : d
        }(a, i))(t[a], e[a], i)
        : s[a] = h(e[a], i))
    }), s
  }
  ...
  const v = (function () {
    ...
    return e.createElement = function (t) {
      ...
      if (f.isObj(t)) { for (const i in t) this.applyAttr(i, t[i]) } else this.applyAttr(t, e)
    }, e.get = function (t) {
  ...
  const b = (function (t) {
    ...
    return m(e, t), e.prototype.applyAttr = function (e, i) {
      e === 'text' ? this.node.textContent = i : t.prototype.applyAttr.call(this, e, i)
    }, e
  }(y))
  const S = (function (t) {
    function e (e, i) {
    ...
    return m(e, t), e.prototype.applyAttr = function (e, i) {
      let s
      e === 'image' ? (f.isObj(i) ? (s = i.url, this.offset = i.offset || [0, 0]) : (s = i, this.offset = [0, 0]), this.node.setAttributeNS('http://www.w3.org/1999/xlink', 'href', s), this.width = 23, this.height = 23, this.applyAttr('width', this.width), this.applyAttr('height', this.height), this.applyAttr('x', this.cx - this.width / 2 + this.offset[0]), this.applyAttr('y', this.cy - this.height / 2 + this.offset[1])) : e == 'cx' ? (this.cx = i, this.width && this.applyAttr('x', i - this.width / 2 + this.offset[0])) : e == 'cy' ? (this.cy = i, this.height && this.applyAttr('y', i - this.height / 2 + this.offset[1])) : t.prototype.applyAttr.apply(this, arguments)
    }, e
  }(y))
  const w = (function (t) {
    function e (e) {
  ...
  function k (t, e, i) {
    const s = f.$(e)
    const a = s.attr('class').indexOf('jvm-region') === -1 ? 'marker' : 'region'
    const r = a === 'region' ? s.attr('data-code') : s.attr('data-index')
    let n = a + ':select'
    return i && (n = a + '.tooltip:show'), {
      event: n,
      type: a,
      code: r,
      element: a === 'region' ? t.regions[r].element : t.markers[r].element,
      tooltipText: a === 'region' ? t.mapData.paths[r].name || '' : t.markers[r].config.name || ''
    }
  }
  const x = (function () {
    function t () {}
  ...
  const M = (function (t) {
    function e (e) {
      ...
      const n = e.style
      const o = e.label
      const h = e.labelStyle
      const l = e.labelsGroup;
  ...
  const E = (function (t) {
    ...
    return i.updateLabelPosition = function () {
      ...
      const i = t.map
      const s = t.label
      const a = t.labelsGroup
      const r = t.cx
      const n = t.cy
      const o = t.marker
      const h = t.isRecentlyCreated
      const l = this.getLabelText(e, s)
  ...
  const O = (function () {
    ...
    return t.prototype.render = function () {
      let t; let e; let i; const s = this._series.scale.getTicks()
      const a = f.createElement('div', 'jvm-legend-inner')
  ...
  const X = (function () {
    ...
    return e.setValues = function (t) {
      const e = {}
      for (const i in t) t[i] && (e[i] = this.scale.getValue(t[i]))
      this.setAttributes(e)
    }, e.setAttributes = function (t) {
      for (const e in t) this._elements[e] && this._elements[e].element.setStyle(this.config.attribute, t[e])
    }, e.clear = function () {
      let t; const e = {}
  ...
  const Y = {
    ...
    aea: function (t, e, i) {
      ...
      const a = 29.5 * this.radDeg
      const r = 45.5 * this.radDeg
      const n = t * this.radDeg
      const o = e * this.radDeg
      const h = (Math.sin(a) + Math.sin(r)) / 2
      const l = Math.cos(a) * Math.cos(a) + 2 * h * Math.sin(a)
      const c = h * (o - s)
      const u = Math.sqrt(l - 2 * h * Math.sin(n)) / h
      const p = Math.sqrt(l - 2 * h * Math.sin(0)) / h
      return {
    ...
    lcc: function (t, e, i) {
      const s = i * this.radDeg
      const a = e * this.radDeg
      const r = 33 * this.radDeg
      const n = 45 * this.radDeg
      const o = t * this.radDeg
      const h = Math.log(Math.cos(r) * (1 / Math.cos(n))) / Math.log(Math.tan(Math.PI / 4 + n / 2) * (1 / Math.tan(Math.PI / 4 + r / 2)))
      const l = Math.cos(r) * Math.pow(Math.tan(Math.PI / 4 + r / 2), h) / h
      const c = l * Math.pow(1 / Math.tan(Math.PI / 4 + o / 2), h)
      const u = l * Math.pow(1 / Math.tan(Math.PI / 4 + 0), h)
      return {
  ...
  const L = (function () {
    ...
    return e.setMinMaxValues = function (t) {
      ...
      let t; const e = {}
      for (const i in this._values) t = parseFloat(this._values[i]), isNaN(t) || (e[i] = this.getValue(t))
      this.setAttributes(e)
    }, e.setAttributes = function (t) {
      for (const e in t) this._map.regions[e] && this._map.regions[e].element.setStyle('fill', t[e])
    }, e.getValue = function (t) {
      for (var e, i = '#', s = 0; s < 3; s++) i += ((e = Math.round(this._fromColor[s] + (this._toColor[s] - this._fromColor[s]) * ((t - this.min) / (this.max - this.min))).toString(16)).length === 1 ? '0' : '') + e
      return i
    }, e.hexToRgb = function (t) {
      let e = 0
      let i = 0
      let s = 0
      return t.length == 4 ? (e = '0x' + t[1] + t[1], i = '0x' + t[2] + t[2], s = '0x' + t[3] + t[3]) : t.length == 7 && (e = '0x' + t[1] + t[2], i = '0x' + t[3] + t[4], s = '0x' + t[5] + t[6]), [parseInt(e), parseInt(i), parseInt(s)]
    }, t
  }())
  const T = Object.freeze({
    __proto__: null,
    handleContainerEvents: function () {
      let t; let e; const i = this
      let s = !1
      const a = this
      this.params.draggable && (this.container.on('mousemove', function (i) {
        ...
        const r = t.pageX - s.left - window.pageXOffset
        const n = t.pageY - s.top - window.pageYOffset
        const o = Math.pow(1 + a.params.zoomOnScrollSpeed / 1e3, -1.5 * e)
    ...
    handleElementEvents: function () {
      ...
      this.container.delegate('.jvm-element', 'mouseover mouseout', function (e) {
        const i = k(t, this, !0)
        const s = t.params.showTooltip
        e.type === 'mouseover' ? e.defaultPrevented || (i.element.hover(!0), s && (t.tooltip.text(i.tooltipText), t.tooltip.show(), t.emit(i.event, [t.tooltip, i.code]))) : (i.element.hover(!1), s && t.tooltip.hide())
      }), this.container.delegate('.jvm-element', 'mouseup', function (e) {
        const i = k(t, this)
        if (i.type === 'region' && t.params.regionsSelectable || i.type === 'marker' && t.params.markersSelectable && !e.defaultPrevented) {
          const s = i.element
    ...
    handleZoomButtons: function () {
      const t = this
      const e = this
      const s = f.createElement('div', 'jvm-zoom-btn jvm-zoomin', '&#43;', !0)
      const a = f.createElement('div', 'jvm-zoom-btn jvm-zoomout', '&#x2212', !0)
    ...
    bindContainerTouchEvents: function () {
      let t; let e; let i; let s; let a; let r; let n; const o = this
      const h = function (h) {
        let l; let c; let u; let p; const d = h.touches
        if (h.type == 'touchstart' && (n = 0), d.length == 1) n == 1 && (u = o.transX, p = o.transY, o.transX -= (i - d[0].pageX) / o.scale, o.transY -= (s - d[0].pageY) / o.scale, o.tooltip.hide(), o.applyTransform(), u == o.transX && p == o.transY || h.preventDefault()), i = d[0].pageX, s = d[0].pageY
        else if (d.length == 2) {
          if (n == 2) c = Math.sqrt(Math.pow(d[0].pageX - d[1].pageX, 2) + Math.pow(d[0].pageY - d[1].pageY, 2)) / e, o.setScale(t * c, a, r), o.tooltip.hide(), h.preventDefault()
          else {
    ...
    createRegions: function () {
      let t, e
      for (t in this.regionLabelsGroup = this.regionLabelsGroup || this.canvas.createGroup('jvm-regions-labels-group'), this.mapData.paths) {
        e = new M({
          map: this,
          code: t,
    ...
    createLines: function (t, e, i) {
      ...
      let a; let r = !1
      let n = !1
      for (const o in this.linesGroup = this.linesGroup || this.canvas.createGroup('jvm-lines-group'), t) {
        const h = t[o]
        for (const l in e) {
    ...
    createMarkers: function (t, e) {
      let i; let s; let a; let r; const n = this
    ...
    createSeries: function () {
      for (const t in this.series = {
        markers: [],
        regions: []
      }, this.params.series) { for (let e = 0; e < this.params.series[t].length; e++) this.series[t][e] = new X(this.params.series[t][e], this[t], this) }
    },
    ...
    setFocus: function (t) {
      ...
      if (t.coords) {
        ...
        const r = this.transX - a.x / this.scale
        const n = this.transY - a.y / this.scale
    ...
    setScale: function (t, e, i, s, a) {
      let r; let n; let o; let h; let l; let c; let u; let p; let d; let f; const m = this
      let g = 0
      const v = Math.abs(Math.round(60 * (t - this.scale) / Math.max(t, this.scale)))
      t > this.params.zoomMax * this.baseScale ? t = this.params.zoomMax * this.baseScale : t < this.params.zoomMin * this.baseScale && (t = this.params.zoomMin * this.baseScale), void 0 !== e && void 0 !== i && (r = t / this.scale, s ? (d = e + this.defaultWidth * (this.width / (this.defaultWidth * t)) / 2, f = i + this.defaultHeight * (this.height / (this.defaultHeight * t)) / 2) : (d = this.transX - (r - 1) / t * e, f = this.transY - (r - 1) / t * i)), a && v > 0
        ? (o = this.scale, h = (t - o) / v, l = this.transX * this.scale, u = this.transY * this.scale, c = (d * t - l) / v, p = (f * t - u) / v, n = setInterval(function () {
        ...
        : (this.transX = d, this.transY = f, this.scale = t, this.applyTransform(), this.emit('viewport:changed', [this.scale, this.transX, this.transY]))
    },
    updateSize: function () {
      this.width = this.container.width(), this.height = this.container.height(), this.resize(), this.canvas.setSize(this.width, this.height), this.applyTransform()
    },
    coordsToPoint: function (t, e) {
      let i; let s; let a; const r = z.maps[this.params.map].projection
      const n = r.centralMeridian
    ...
    getInsetForPoint: function (t, e) {
      let i; let s; const a = z.maps[this.params.map].insets
    ...
    repositionLabels: function () {
      ...
      if (t) {
        if (t.regions) { for (const e in this.regions) this.regions[e].element.updateLabelPosition() }
        if (t.markers) { for (const i in this.markers) this.markers[i].element.updateLabelPosition() }
      }
    },
  ...
  var z = (function () {
    ...
    return e.init = function (t) {
      ...
      for (const i in A) A[i] === t && f.isFunc(this.params[i]) && this.params[i].apply(this, e)
      ...
      for (const t in this.series) { for (let e = 0; e < this.series[t].length; e++) this.series[t][e].clear() }
